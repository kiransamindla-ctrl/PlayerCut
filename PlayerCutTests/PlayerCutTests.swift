...
// (DeviceCapabilitiesTests removed when the custom AVCaptureSession
//  retired; the format ladder + recipe selection it covered no longer
//  exist. SoCTier mapping is still in DeviceCapabilities for ETA
//  bookkeeping but is too thin to merit a dedicated test class.)
